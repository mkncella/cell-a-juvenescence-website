...
@section('content')
    ...
    <section class="products-section flex gap-4 lg:gap-8 px-12 py-8">
        <div class="filter-products flex flex-col gap-4">
            ...
            <ul class="list-product-category flex flex-col gap-2 items-between ">
        ...
        <div class="flex flex-col gap-4">
            <div class="card-list flex flex-wrap items-center justify-center w-full gap-4">
                @foreach ($products as $product)
                    ...
                    <div class="flex-0 basis-44 max-w-[14rem] rounded-lg p-4 border overflow-hidden relative box-border h-60" x-data="{
                        isLiked: false,
                        toggle() {
                        ...
                        <div class="head">
                            ...
                            <div class="absolute top-0 left-0 right-0 flex justify-between gap-4">
                                ...
                                {{-- right for love? --}}
                                {{-- <div class="absolute right-0 p-2" x-show="!isLiked" @click="toggle">
                                ...
                                <div class="absolute right-0 p-2" x-show="isLiked" @click="toggle">
                                    <svg class="w-6 h-6 text-red-700" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M20.808,11.079C19.829,16.132,12,20.5,12,20.5s-7.829-4.368-8.808-9.421C2.227,6.1,5.066,3.5,8,3.5a4.444,4.444,0,0,1,4,2,4.444,4.444,0,0,1,4-2C18.934,3.5,21.773,6.1,20.808,11.079Z"></path></g></svg>
                                </div> --}}
                        ...
                        <div class="body">
                            ...
                            <p class="text-xs mb-1">{{ Str::limit($product['description'], 20, '...') }}</p>
