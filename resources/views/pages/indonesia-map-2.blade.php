...
@section('content')
    ...
    <section class="reseller-tabs-section relative" x-data="() => ({
        stores: @js($stores),
        rewards: @js($rewards),
        markers: {},
        ...
        <div>
            <section x-ref="joinReseller" x-show="activeTab == 'join'" id="join">
            ...
            <section id="off" x-ref="officialReseller" x-show="activeTab == 'official'" class=" pt-8" id="official">
